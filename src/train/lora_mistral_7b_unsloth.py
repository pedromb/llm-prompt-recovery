...
DATASET =  str(DATA_PATH / "final_data.csv" )
PROJECT = "finetuned-unsloth-new"
...
def format_single(input, output):
    return f"""<s> [INST]
        ...
        Your job is to return the prompt that was used to transform the original_text into the rewritten_text.
